...
```{exec}
#| engine.opts: !expr list(command = "python")
print(1 + 1)
```
...
```{exec}
#| engine.opts: !expr list(command = "python", input = input2)
print(1 + 1)
```
...
```{exec}
#| command: python
#| engine.opts: !expr list(input = "myfile.py")
print(1 + 1)
```
...
```{exec}
#| engine.opts: !expr list(command = "Rscript", ext = "R")
1 + 1
```
...
```{exec}
#| command: python
#| engine.opts: !expr list(ext = ext_fun)
print(1 + 1)
```
...
```{exec}
#| engine.opts: !expr list(command = "python", args = f_arg)
print(1 + 1)
```
...
```{exec}
#| engine.opts: !expr list(command = "python", args1 = "-x", args = f_arg)
print(1 + 1)
```
...
```{cat}
#| engine.opts: !expr list(file = "custom.py", lang = "python")
...
```{exec}
#| command: python
#| engine.opts: !expr list(args = "custom.py")
#| echo: false
```
...
```{exec}
#| command: python
#| engine.opts: !expr list(args2 = "hello")
import sys
...
```{exec}
#| command: python
#| engine.opts: !expr list(clean = NULL)
...
```{exec}
#| command: python
#| engine.opts: !expr list(input = "tmp-debug.py", clean = NULL)
