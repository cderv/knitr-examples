...
<<>>=
#| label: fig-cap
#| fig.cap: !expr c("One plot.", "Another plot.")
...
#| label: fig-out
#| ref.label: fig-cap
#| out.width: !expr c("1in", ".4\\linewidth")
@
...
#| label: fig-extra
#| ref.label: fig-cap
#| out.extra: !expr sprintf("angle=%d", c(30, 120))
@
...
#| ref.label: fig-cap
#| fig.cap: two plots
#| fig.subcap: !expr c("one plot", "the other one")
...
#| label: fig-margin
#| ref.label: fig-cap
#| fig.cap: !expr c("ordinary figure", "sideways figure")
#| fig.env: !expr c("figure", "sidewaysfigure")
@
